...
def get_last_modified_time(file_path):
    ...
    if os.path.exists(originalPath):
        ...
        return datetime.now(timezone.utc).isoformat()  # Default to current time if file doesn't exist
...
print(f"sitemap.xml has been generated successfully at {output_file}")
