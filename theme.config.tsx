...
const config: DocsThemeConfig = {
  ...
  logo: <span className="flex"><img src="/logo.svg" width={30} height={30} alt="Quran API Logo" /><b>Quran API</b></span>,
  project: {
  ...
  docsRepositoryBase: "https://github.com/The-Quran-Project/Quran-API/tree/main/",
  footer: {
