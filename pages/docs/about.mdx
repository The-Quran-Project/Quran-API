...
Quran API is a REST API that gives verses, chapters, translations, and more from the Quran. It is free to use and has no rate limits. The API was built and maintained by [Nusab Taha](https://nusab19.pages.dev).
...
Special thanks to [AH Nayef](https://github.com/ahnayef) for contributing to the project. 
